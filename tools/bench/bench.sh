...
MAX_SYS_BYTES="${MAX_SYS_BYTES:-402653184}"
MAX_STEADY_GOROUTINES_PER_CHANNEL="${MAX_STEADY_GOROUTINES_PER_CHANNEL:-17}"
...
python3 "${ROOT_DIR}/tools/bench/bench_check.py" \
  ...
  --max-sys-bytes "${MAX_SYS_BYTES}" \
  --max-steady-goroutines-per-channel "${MAX_STEADY_GOROUTINES_PER_CHANNEL}" \
