...
var signedMetricContracts = []MetricContract{
	...
	metricLower("mobile_bulk_goodput_mbps", 0.15, "megabits_per_second"),
...
var signedProfiles = []signedProfile{
	...
	},
	{
		...
		rpc:                    RPCWorkload{Operations: 30, RequestBytes: 1024, ResponseBytes: 1024, Workers: 30, Retries: 0, OperationDeadlineSeconds: 24, PhaseDeadlineSeconds: 26},
		bulk:                   BulkWorkload{WarmupBytesPerDirection: 64 * kib, ScoreBytesPerDirection: 128 * kib, PhaseDeadlineSeconds: 21},
		cleanupDeadlineSeconds: 12,
		cellWatchdogMinutes:    5,
	},
}
