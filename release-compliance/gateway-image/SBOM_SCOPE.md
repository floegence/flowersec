...
The SPDX and CycloneDX documents in `sbom/` describe the runtime dependency union for the exact gateway-image targets and platforms declared in `scripts/release-go-targets.json`.
