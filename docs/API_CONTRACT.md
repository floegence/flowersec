# Flowersec 5 Public API Contract
...
The source tree defines the Flowersec 5 SDK contract over Transport v3. The
...
The Go-only server import `github.com/floegence/flowersec/flowersec-go/v5/controlplane`, conventionally named `controlplane`, issues v3 artifacts and answers the `flowersec-runtime` authorization callback without exposing carrier, candidate, FSB3, PSK, or session-contract objects.
