...
- Session values: `flowersec.Session`, `flowersec.Metadata`, `flowersec.NewMetadata(...)`, `flowersec.ErrInvalidMetadata`, `flowersec.ByteStream`, `flowersec.IncomingStream`, and `flowersec.RPCPeer`.
