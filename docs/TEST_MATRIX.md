...
| Strict previous-version rejection and current codec isolation | `testdata/transport_v3/version_isolation_vectors.json`, consumed by production decoders in Go, TypeScript, Rust, and Swift |
