...
| --- | :---: | :---: | :---: | :---: |
| Непрозрачные одноразовые приглашения на подключение | Да | Да | Да | Да |
| Одноразовое защищённое подключение | Да | Да | Да | Да |
| Сессии со сквозным шифрованием | Да | Да | Да | Да |
| RPC-вызовы и уведомления | Да | Да | Да | Да |
| Проверенные метаданные потока | Да | Да | Да | Да |
| Обработчики потоков приложения | Да | Да | Да | Да |
| Восстановление долгоживущих подключений | Да | Да | Да | Да |
| Согласованные ненадёжные сообщения | Да | Да | Нет | Да |
| Клиентские обработчики RPC | Да | Да | Нет | Да |
| Приём сессий на сервере | Да | Да | Нет | Да |
| Обработчики серверных сессий | Да | Да | Нет | Да |
| Выпуск и авторизация в управляющей плоскости | Да | Нет | Нет | Нет |
| Допуск прямых и туннельных подключений | Да | Да | Нет | Да |
| HTTP- и WebSocket-ProxyServer | Да | Да | Нет | Да |
| Независимый от транспорта контракт потока | Да | Да | Да | Да |
| Безопасность wire-протокола Transport v3 | Да | Да | Да | Да |
