...
- **Прямое соединение или relay.** Используйте кратчайший прямой путь WebSocket, когда Endpoint доступен, либо собственный Tunnel без передачи ему открытых данных приложения.
...
![Схемы защищённых соединений Flowersec](docs/flowersec-connection-patterns-whiteboard.png)
