...
func TestClassifyTunnelAttachCloseCode(t *testing.T) {
	cases := []struct {
		...
		{"tenant_mismatch", &websocket.CloseError{Code: websocket.ClosePolicyViolation, Text: "tenant_mismatch"}, CodeTenantMismatch, true},
		{"policy_denied", &websocket.CloseError{Code: websocket.ClosePolicyViolation, Text: "policy_denied"}, CodePolicyDenied, true},
		{"policy_error", &websocket.CloseError{Code: websocket.ClosePolicyViolation, Text: "policy_error"}, CodePolicyError, true},
