// Package webtransportv3 adapts HTTP/3 WebTransport native bidirectional
...
const (
	PathDirect = "/flowersec/webtransport/v3/direct"
	PathTunnel = "/flowersec/webtransport/v3/tunnel"
...
var (
	ErrInvalidURL              = errors.New("invalid WebTransport v3 URL")
	...
	ErrSessionResumption       = errors.New("WebTransport TLS session resumption is forbidden")
...
// OpenAdmissionStream creates the server-owned native stream for the FSB3/FSA3
