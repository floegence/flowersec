...
func registryForOS(goos string) []registeredTest {
	tests := []registeredTest{
		...
		commandEntry("controller/rust", "acceptance", 5*time.Minute, "cargo", "test", "--manifest-path", "flowersec-rust/Cargo.toml", "--all-features", "--lib", "connection_controller::"),
		...
		commandEntry("protocol/rust", "acceptance", 5*time.Minute, "cargo", "test", "--manifest-path", "flowersec-rust/Cargo.toml", "--all-features", "--lib", "v3"),
		...
		commandEntry("server/rust-acceptor", "acceptance", 5*time.Minute, "cargo", "test", "--manifest-path", "flowersec-rust/Cargo.toml", "--all-features", "--lib", "connector_v3::tests::production_websocket_connector_completes_ca_admission_and_session", "--", "--exact"),
		commandEntry("server/rust-acceptor-handlers", "acceptance", 5*time.Minute, "cargo", "test", "--manifest-path", "flowersec-rust/Cargo.toml", "--all-features", "--lib", "connector_v3::tests::production_websocket_acceptor_binds_handlers_before_session_establishment", "--", "--exact"),
		...
		commandEntry("carrier/rust-websocket-direct", "acceptance", 5*time.Minute, "cargo", "test", "--manifest-path", "flowersec-rust/Cargo.toml", "--all-features", "--lib", "connector_v3::tests::production_websocket_connector_completes_ca_admission_and_session", "--", "--exact"),
		commandEntry("carrier/rust-websocket-tunnel", "acceptance", 5*time.Minute, "cargo", "test", "--manifest-path", "flowersec-rust/Cargo.toml", "--all-features", "--lib", "connector_v3::tests::production_wss_tunnel_runtime_relays_a_complete_v3_session", "--", "--exact"),
		commandEntry("carrier/rust-raw-quic-tunnel", "acceptance", 5*time.Minute, "cargo", "test", "--manifest-path", "flowersec-rust/Cargo.toml", "--all-features", "--lib", "raw_quic_v3_integration_tests::production_raw_quic_tunnel_runtime_relays_a_complete_v3_session", "--", "--exact"),
		...
		vitestEntry("interop/typescript-go/http-direct", "acceptance", "src/interop/httpDirectV1.integration.test.ts", "shares one application port and preserves two independent sessions"),
		vitestEntry("protocol/typescript-http-direct", "acceptance", "src/browser/httpDirectV1.test.ts", ""),
		commandEntry("protocol/go-http-direct", "acceptance", 5*time.Minute, "go", "-C", "flowersec-go", "test", "-timeout=5m", "-count=1", "./internal/httpdirectv1"),
		...
		commandEntry("interop/rust-go/raw-quic/direct", "acceptance", 5*time.Minute, "cargo", "test", "--manifest-path", "flowersec-rust/Cargo.toml", "--all-features", "--lib", "raw_quic_v3_integration_tests::go_and_rust_run_full_v3_sessions_in_both_directions_for_direct_and_tunnel", "--", "--exact"),
		commandEntry("interop/rust-go/raw-quic/tunnel", "acceptance", 5*time.Minute, "cargo", "test", "--manifest-path", "flowersec-rust/Cargo.toml", "--all-features", "--lib", "raw_quic_v3_integration_tests::go_and_rust_run_full_v3_sessions_in_both_directions_for_direct_and_tunnel", "--", "--exact"),
		commandEntry("interop/go-rust/raw-quic/direct", "acceptance", 5*time.Minute, "cargo", "test", "--manifest-path", "flowersec-rust/Cargo.toml", "--all-features", "--lib", "raw_quic_v3_integration_tests::go_and_rust_run_full_v3_sessions_in_both_directions_for_direct_and_tunnel", "--", "--exact"),
		commandEntry("interop/go-rust/raw-quic/tunnel", "acceptance", 5*time.Minute, "cargo", "test", "--manifest-path", "flowersec-rust/Cargo.toml", "--all-features", "--lib", "raw_quic_v3_integration_tests::go_and_rust_run_full_v3_sessions_in_both_directions_for_direct_and_tunnel", "--", "--exact"),
		commandEntry("carrier/rust-tls13-handshake", "acceptance", 5*time.Minute, "cargo", "test", "--manifest-path", "flowersec-rust/Cargo.toml", "--all-features", "--lib", "tls_v3::tests::configs_are_tls13_only_without_early_data_or_resumption", "--", "--exact"),
		commandEntry("carrier/rust-tls-rejection", "acceptance", 5*time.Minute, "cargo", "test", "--manifest-path", "flowersec-rust/Cargo.toml", "--all-features", "--lib", "tls_v3::tests"),
