...
func registry() []registeredTest {
	tests := []registeredTest{
		...
		commandEntry("carrier/go-webtransport-draft15-wire", "acceptance", 5*time.Minute, "go", "-C", "flowersec-go", "test", "-timeout=5m", "-count=1", "-run", "^TestServerUsesOnlyDraft15SettingsAndConnectProtocol$", "./internal/carrier/webtransport"),
