...
func TestOpenAdaptiveEndpointRejectsInvalidCandidates(t *testing.T) {
	tests := []struct {
		...
		{name: "empty ID", candidates: []AdaptiveCandidate{{Kind: carrier.KindWebSocket}, {ID: "quic", Kind: carrier.KindQUIC}}},
		{name: "duplicate ID", candidates: []AdaptiveCandidate{{ID: "same", Kind: carrier.KindWebSocket}, {ID: "same", Kind: carrier.KindQUIC}}},
...
func TestAdaptiveEndpointRacesProductionCarriers(t *testing.T) {
	for _, test := range []struct {
		...
		{name: "native", candidates: []AdaptiveCandidate{{ID: "runtime-wss", Kind: carrier.KindWebSocket}, {ID: "runtime-raw-quic", Kind: carrier.KindQUIC}}},
