...
- **直接接続または中継。** Endpoint に到達できる場合は最短の WebSocket 直接経路を使い、到達できない場合はアプリケーションの平文を Tunnel に渡さず、セルフホストした Tunnel で接続します。
...
![Flowersec の安全な接続パターン](docs/flowersec-connection-patterns-whiteboard.png)
