...
function serverConfig(artifact: ArtifactV2, fsb2: ReturnType<typeof decodeFSB2RequestV2>): SessionConfigV2 {
  ...
  let localBinding = fsb2.localAdmissionBinding;
  if (tunnel !== undefined) {
    if (fsb2.request.pathKind !== "tunnel") throw new Error("tunnel artifact received a direct admission request");
    localBinding = admissionBindingV2(encodeFSB2RequestV2({
        ...fsb2.request,
        role: 2,
