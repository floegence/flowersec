import {
  CarrierError,
  type CarrierUnreliableDatagramsV3,
  type NativeCarrierSessionV3,
  type NativeCarrierStreamV3,
} from "./carrier.js";
...
export function adaptWebTransportCarrierSessionV3(
  native: WebTransportSessionLikeV3,
  options: Readonly<{
    path: PathKind;
...
export function hasWebTransportConstructorSurfaceV3(value: unknown): boolean {
...
function requireWebTransportSessionSurfaceV3(value: WebTransportSessionLikeV3): void {
...
class WebTransportCarrierSessionAdapter implements NativeCarrierSessionV3 {
  ...
  private readonly incoming: ReadableStreamDefaultReader<WebTransportBidirectionalLikeV3>;
  ...
  constructor(
    private readonly native: WebTransportSessionLikeV3,
    options: Readonly<{
      path: PathKind;
      inboundBidirectionalStreamCapacity: number;
      datagramMaxSize?: number;
  ...
  async openStream(options: OperationOptionsV3 = {}): Promise<NativeCarrierStreamV3> {
    this.assertOpen();
    ...
    let stream: WebTransportBidirectionalLikeV3;
    try {
  ...
  async acceptStream(options: OperationOptionsV3 = {}): Promise<NativeCarrierStreamV3> {
    this.assertOpen();
  ...
  private track(
    native: WebTransportBidirectionalLikeV3,
    incoming = false,
...
class WebTransportCarrierStreamAdapter implements NativeCarrierStreamV3 {
...
class WebTransportDatagramAdapter implements CarrierUnreliableDatagramsV3 {
  ...
  constructor(native: WebTransportDatagramsLikeV3, configuredMaxSize: number | undefined) {
...
function abortNativeStream(stream: WebTransportBidirectionalLikeV3, error: Error): void {
